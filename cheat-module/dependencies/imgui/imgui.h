...
namespace ImGui
{
    ...
    IMGUI_API bool          SelectableConfig(const char* label, bool selected = false, bool state = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          Selectable(const char* label, bool* p_selected, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));       // "bool* p_selected" point to the selection state (read-write), as a convenient helper.
    IMGUI_API bool          SelectableConfig(const char* label, bool* p_selected, bool* state, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
