...
uint8_t* c_memory_mgmt::find_ptr(const std::string_view module, const std::string_view signature) {
	...
	{
		const auto image_start = reinterpret_cast<uint8_t*>(LI_CALL(GetModuleHandleA)(module.data()));
