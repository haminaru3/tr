...
//#define StartWarnFunc //ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(169 / 255.f, 169 / 255.f, 95 / 255.f, 1.f));
//#define EndWarnFunc //ImGui::PopStyleColor(1);
...
#define InsertColorPicker(x1,x2,x3) ImGui::SameLine(219.f); cpicker(x1, x2, x3);

#define InsertButtonStart(x1) ImGui::Spacing(); ImGui::NewLine(); ImGui::SameLine(42.f); if (ImGui::Button(x1, ImVec2(158, 25))) { 
#define InsertButtonEnd }; ImGui::CustomSpacing(1.f);

#define InsertKeybind(x1, x2) ImGui::SameLine(219.f); keybind(x1, &x2, false);
